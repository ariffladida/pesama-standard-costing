...
class FjCostingResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Kiraan FJ';
                ...
                Grid::make(['default' => 1, 'xl' => 12])
                    ->schema([
                        ...
                        Grid::make(1)->columnSpan(['xl' => 8])->schema([
                            ...
                            // 1. SPESIFIKASI PRODUK & KOS KD (WAJIB)
                            Section::make('1. Spesifikasi Produk Profil Finger Joint')
                                    ...
                                    Grid::make(3)->schema([
                                        ...
                                        Select::make('profile_size')
                                            ...
                                            ->options([
                                                ...
                                                'Custom Profil FJ'               => 'Custom Profil FJ',
                                            ])
                                            ->searchable()
                                            ->preload()
                                            ->required(),

                                        // KD Cost / Tan - WAJIB ADA
                                        TextInput::make('kd_cost_per_ton')
                                            ->label('Kos KD / Tan (Wajib)')
                                            ->helperText('Caj pengeringan (KD) bahan short length')
                                            ->numeric()
                                            ->prefix('RM')
                                            ->default(120.00)
                                            ->required()
                            ...
                            Section::make('2. Bahan Mentah & Batch Intake (Short Length)')
                                ->description('Kemasukan batch kayu pendek. Spesies Meranti dikecualikan.')
                                    ...
                                    Repeater::make('items')
                                        ...
                                        ->schema([
                                            ...
                                            Select::make('species_id')
                                                ->label('Spesies Kayu (Tanpa Meranti)')
                            ...
                            // 3. PENETAPAN MARGIN & HARGA JUALAN (TIADA PROSES TAMBAHAN)
                            ...
                            Section::make('Ringkasan Kos & Benchmark')
                                ...
                                ->schema([
                                    ...
                                    TextInput::make('manufacturing_cost_per_ton')
                                        ->label('Kos Pembuatan (COA FJ - 75 Tan)')
                                        ->helperText('Berdasarkan 81 kod akaun loji sekunder FJ.')
                                        ->numeric()
                                        ->prefix('RM')
                                        ->default('687.86')
                                        ->live(onBlur: true)
                                    ...
                                    TextInput::make('total_cost_per_ton')
                                        ...
                                        ->helperText('Bahan Mentah + Kos KD + Kos Pembuatan (COA FJ)')
                                        ->numeric()
                                        ->prefix('RM')
                                        ->default(0.00)
                                        ->readOnly(),
    ...
    public static function recalculateTotals($livewire): void
    {
        ...
        // 4. Formula: Total Standard Cost = Raw Material + KD Cost + Manufacturing Cost
        $totalStandard = $avgRawCost + $kdCost + $mfgCost;

        // 5. Formula Margin Sasaran
