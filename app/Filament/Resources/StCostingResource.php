...
class StCostingResource extends Resource
{
    ...
    public static function getSawmillCoas()
    {
        ...
        return $form
            ->schema([
                Grid::make(['default' => 1, 'xl' => 12])
                    ->schema([
                        // =========================================================================
                        // BAHAGIAN UTAMA: INPUT PEGAWAI (8 / 12 KOLUM)
                        // =========================================================================
                            ...
                            Section::make('Ringkasan Kos & Benchmark')
                                ...
                                ->schema([
                                    ...
                                    TextInput::make('manufacturing_cost_per_ton')
                                        ...
                                        ->numeric()
                                        ->prefix('RM')
                                        ->default(fn () => number_format(self::calculateSawmillMfgCost(), 2, '.', ''))
                                        ->live(onBlur: true)
                                        ->afterStateUpdated(fn ($livewire) => self::recalculateTotals($livewire))
                                        ->suffixAction(
